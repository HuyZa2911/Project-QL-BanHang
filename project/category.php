...
foreach ($company as $c) {
    ...
    ?>
        ...
        <div class="col-md-2">
            <div class="br">
            <a href="/<?php echo BASE_URL; ?>/company.php/<?php echo $cat . '-' . $c['company_id']; ?>"><img src="/<?php echo BASE_URL; ?>/public/images/<?php echo $c['company_image']; ?>"style="width:100%; height:100px"class="img-fluid"></a>
            </div>
        </div>
